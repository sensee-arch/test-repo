...
(function () {
  ...
  function getAllTasks() {
    try {
      ...
      console.warn('[TodoList] Failed to read localStorage:', e.message);
      return [];
    }
  }
  ...
  function saveTasks(tasksArray) {
    try {
      ...
      console.warn('[TodoList] Failed to write localStorage:', e.message);
    }
  }

  // --- CRUD Operations ---

  /** Add a new task. Returns the created Task or null on failure. */
  ...
  function renderCounter() {
    ...
    els.taskCounter.textContent = active + ' / ' + total + ' 项未完成';
  }
  ...
  function enableInlineEdit(span, taskId) {
    ...
    function finishEdit(save) {
      ...
      sel.removeAllRanges ? sel.removeAllRanges() : null;
